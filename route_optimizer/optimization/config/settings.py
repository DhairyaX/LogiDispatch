...
class BalancingMode(str, Enum):
    """Selects how aggressively to balance workloads across vehicles."""
...
class OptimizerSettings:
    ...
    # Whether to attempt balancing the workload across vehicles.
    balance_workload: bool = True

    # Balancing mode: STRICT, BALANCED, or DISTANCE_OPTIMAL.
    balancing_mode: BalancingMode = BalancingMode.BALANCED

    # Weight applied to the workload span cost.
